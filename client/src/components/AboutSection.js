...
function AboutUs() {
  return (
    <section className={styles.aboutUs}>
      {/* About MidCity Section with Consistent Heading */}
      <div className={styles.aboutMidcityHeading}>
        <div className={styles.aboutMidcityContent}>
          <span className={styles.aboutMidcityText}>About MidCity</span>
          <div className={styles.aboutMidcityUnderline}></div>
        </div>
      </div>
      ...
      <div className={styles.specialtiesHeading}>
        <div className={styles.specialtiesContent}>
          <span className={styles.specialtiesText}>Specialties</span>
          <div className={styles.specialtiesUnderline}></div>
        </div>
      </div>
